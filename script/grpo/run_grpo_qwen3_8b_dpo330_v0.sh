...
TRAIN_DATA="${TRAIN_DATA:-${PROJECT_ROOT}/data/alignment/grpo/v1/train/medical_grpo_prompt_v1.train.jsonl}"
VALID_DATA="${VALID_DATA:-${PROJECT_ROOT}/data/alignment/grpo/v1/valid/medical_grpo_prompt_v1.valid.jsonl}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/outputs/grpo}"
RUN_NAME="${RUN_NAME:-$(date +%Y%m%d_%H%M%S)_qwen3-8b_dpo330_grpo_v0}"
